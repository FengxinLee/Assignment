...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />作业提交系统-教师端   </h1>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="list.jsp" target="right"><span class="icon-caret-right"></span>课程管理</a></li>
...
<%
if(user == null || user.equals("null") || role != 0)
{
